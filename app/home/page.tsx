            ...
            <FadeSection>
              <section className="mb-12">
                ...
                >
                  ...
                  and devlogs (behind-the-scenes game development videos). I
                  enjoy gaming, though I&apos;m not playing much these days.
                  When I&apos;m on the move, you&apos;ll often find me diving
                  into manhwa, manga, or novels.
                </p>
              </section>
            </FadeSection>
              ...
              <section className="mb-12">
                ...
                >
                  ...
                  <p
                    ...
                    style={{ color: textMid }}
                  >
                    This work explores the use of PPO for managing NextG
                    networks, focusing on stabilizing latency and signal
                    strength. The proposed framework dynamically adjusts network
                    parameters to optimize traffic control, ensuring efficient
                    data transmission while maintaining power and latency
                    limits.
                  </p>
